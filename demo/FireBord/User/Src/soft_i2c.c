/*
 * @Author: Liang 
 * @Date: 2025-03-06 18:12:05
 * @LastEditors: HA HA 
 * @LastEditTime: 2025-11-19 20:18:14
 * @Description: iic  PB6--SCL  PB7--SDA
 * 
 * Copyright (c) 2025 by ${git_name_email}, All Rights Reserved.
 */
#include "soft_i2c.h"
//5--400K  3--500k  2-555k
uint16_t 	soft_i2c_delay = 5;
...
{
	/*user code*/
	//HAL_GPIO_WritePin(I2C_GPIO_PORT, GPIO_PIN_7, GPIO_PIN_SET);
	I2C_GPIO_PORT->BSRR = I2C_SDA_PIN; // SDA先置高
}
...
{
	/*user code*/
    //HAL_GPIO_WritePin(I2C_GPIO_PORT, GPIO_PIN_7, GPIO_PIN_RESET);
	I2C_GPIO_PORT->BSRR = I2C_SDA_PIN << 16; // SDA拉低（BSRR高16位=清位）
}
...
{
	/*user code*/
    //HAL_GPIO_WritePin(I2C_GPIO_PORT, GPIO_PIN_6, GPIO_PIN_SET);
	I2C_GPIO_PORT->BSRR = I2C_SCL_PIN; // SCL拉高
}
...
{
	/*user code*/
    //HAL_GPIO_WritePin(I2C_GPIO_PORT, GPIO_PIN_6, GPIO_PIN_RESET);
	I2C_GPIO_PORT->BSRR = I2C_SCL_PIN << 16; // SCL拉低
}
...
static unsigned char i2c_read_sda(void)
{
    ...
    if (HAL_GPIO_ReadPin(I2C_GPIO_PORT, GPIO_PIN_7) == GPIO_PIN_SET) {
        return 1;
    } else {
        return 0;
    }
