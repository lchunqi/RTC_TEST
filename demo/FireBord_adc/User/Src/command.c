 ...
 * @LastEditTime: 2025-11-17 10:40:31
 * @Description: 
 * 
...
{
	uint8_t buffer[7]={0X01,0X02,0X03,0X04,0X05,0X06,0X07},DATA[7]={0};
	
	// if(HAL_I2C_Mem_Write(&hi2c1, DEV, 0X00, I2C_MEMADD_SIZE_8BIT,buffer, 7, 1000)==HAL_OK)
	// {
		if(HAL_I2C_Mem_Read(&hi2c1, DEV, SEC, I2C_MEMADD_SIZE_8BIT, DATA, 7, 1000)==HAL_OK)
		{
			for (int i = 0; i < 7; i++)
			{
			...
			UsbPrintf("iic Receive error !\n");
		}
	// }else{
	// 	UsbPrintf("iic Transmit error !\n");
	// }
