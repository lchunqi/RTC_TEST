 ...
 * @LastEditors: HA HA 
 * @LastEditTime: 2025-03-07 15:28:39
...
static inline void i2c_sda_h(void)
{
	...
	HAL_GPIO_WritePin(I2C_GPIO, GPIO_PIN_7, GPIO_PIN_SET);
}
...
{
	/*user code*/
    HAL_GPIO_WritePin(I2C_GPIO, GPIO_PIN_7, GPIO_PIN_RESET);
}
...
{
	/*user code*/
    HAL_GPIO_WritePin(I2C_GPIO, GPIO_PIN_6, GPIO_PIN_SET);
}
...
{
	/*user code*/
    HAL_GPIO_WritePin(I2C_GPIO, GPIO_PIN_6, GPIO_PIN_RESET);
}
...
{
	/*user code*/
    if (HAL_GPIO_ReadPin(I2C_GPIO, GPIO_PIN_7) == GPIO_PIN_SET) {
        return 1;
    } else {
        return 0;
    }
