...
#define VERSION_SD8800    0
#define VERSION_SD8801    1
#define VERSION_SD8804    4
#define VERSION_SELECT  VERSION_SD8800   //¸ü¸Ä°æ±¾
#define HARD_VERSION    "Board V1.3"


#if (VERSION_SELECT == VERSION_SD8801)
#define SOFT_VERSION    "SD8801V1.5"
#elif (VERSION_SELECT == VERSION_SD8804)
#define SOFT_VERSION    "SD8804V1.5"
#else
#define SOFT_VERSION    "SD8800V1.5"
#endif
