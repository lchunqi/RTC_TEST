...
{	//sda_key
	...
	uint8_t chip_switch[100][2] = {//记录每个芯片对应的模拟开关序号和8选1序号
	...
	if (channel > 99) {//最多100个芯片
		channel = 99;
	}
	//4051模拟开关的片选信号由4067选中
	...
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_10, chip_switch[channel][0] & 0x04);//切换模拟开关
	HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11, chip_switch[channel][0] & 0x08);//切换模拟开关
	//4051的地址线
	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10, chip_switch[channel][1] & 0x01);//切换模拟开关
	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_11, chip_switch[channel][1] & 0x02);//切换模拟开关
	HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, chip_switch[channel][1] & 0x04);//切换模拟开关
}
