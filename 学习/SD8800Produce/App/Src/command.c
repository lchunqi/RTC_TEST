...
void AT_1006TMODE_Handle(char* command)
{
	...
	if (mode > 0) {
		...
		// if (drv_wave1006_read_reg(DEV_SD3068, WAVE1006_REG_USER_RAM_START + 25, 1, &osc_buf[1]) != WAVE1006_EXIT_OK)  //读ram26   
		// {
		// 	return;
		// }
		// osc_buf[1] &= 0xfc;
		// osc_buf[1] |= 0x01;//0x01 use IO6, 0x10 use IO8 
		// if (drv_wave1006_write_reg(DEV_SD3068, WAVE1006_REG_USER_RAM_START + 25, 1, &osc_buf[1]) != WAVE1006_EXIT_OK)    //写ram26
		// {
		// 	return;
		// }
