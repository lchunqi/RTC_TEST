...
//模拟串口定时器，设置波特率为9600，兼容3178控制板
//时钟源84MHz,3倍波特率就是84000000 / 9600 / 3 = 2916.666
//定时时间：（Prescaler + 1） * （Period + 1) / 84MHz 
  /* USER CODE END TIM3_Init 1 */
  htim3.Instance = TIM3;
  htim3.Init.Prescaler = 0;
  htim3.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim3.Init.Period = 84000000L / (SOFT_UART_BAUDRATE * MULTIPLE_OF_TIEMR);
