...
int main(void)
{
  ...
  osThreadDef(communicateTask, StartCommunicateTask, osPriorityNormal, 1, 1024);
  communicateTaskHandle = osThreadCreate(osThread(communicateTask), NULL);
  
  osThreadDef(devicesTask, StartDevicesTask, osPriorityHigh, 1, 1024);
  devicesTaskHandle = osThreadCreate(osThread(devicesTask), NULL);
  
  osThreadDef(wifiTask, StartWifiTask, osPriorityNormal, 1, 512);
