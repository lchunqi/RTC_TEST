...
rtc_exit_code SD8563_read_addr(uint8_t reg_addr, uint8_t *read_buf, uint8_t length, i2c_device_bus bus);
rtc_exit_code SD8563_write_addr(uint8_t reg_addr, uint8_t *write_buf, uint8_t length, i2c_device_bus bus);
...
uint8_t RTC_ReadRAM_8563(uint8_t addr,uint8_t *data,uint8_t len,i2c_device_bus IIC_x);
uint8_t RTC_WriteRAM_8563(uint8_t addr,uint8_t *data,uint8_t len,i2c_device_bus IIC_x);
