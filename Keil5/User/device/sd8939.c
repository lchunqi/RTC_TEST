...
返回值：TRUE-成功
**/
uint8_t sd8939_idbuff(uint16_t *Data, i2c_device_bus IIC_x)
{
...
{	
		uint16_t buf=0x1C;
		if(SD8939_write_addr(0x0E,&buf,1,IIC_x)!=RTC_OK)
			return RTC_FAIL;
...
返回值：sd8939_read_addr(addr,data,len,IIC_x)-读取到的数据
**/
