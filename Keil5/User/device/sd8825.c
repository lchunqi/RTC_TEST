...
返回值：TRUE-成功
**/
uint8_t sd8825_idbuff(uint16_t *Data, i2c_device_bus IIC_x)
{
...
{	
		uint16_t buf=0x0C;
		if(SD8825_write_addr(0x0D,&buf,1,IIC_x)!=RTC_OK)
			return RTC_FAIL;
...
返回值：sd8825_read_addr(addr,data,len,IIC_x)-读取到的数据
**/
