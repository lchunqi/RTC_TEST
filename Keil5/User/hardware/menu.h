...
typedef enum {  
    RTC_Series_Display,  //显示信息
    RTC_Series_WaitBack  //返回
} RTC_Series_State; 


typedef enum {  
    RTC_and_std_Display,  //显示信息
    RTC_and_std_WaitBack  //返回
} RTC_and_std_State; 

typedef enum {  
    RTC_Freq_Display,  //频率显示
    RTC_Freq_WaitBack  //返回
} RTC_Freq_State; 
...
void Third_2Ui_8_1(void);//22xxx
void Third_2Ui_8_2(void);
void Third_2Ui_8_3(void);
void Third_2Ui_8_4(void);
void Third_2Ui_8_5(void);
...
void SD20XXX_and_std(void);//对比测试
...
void SD2201_Series(void);//单独测试
void SD2201_and_std(void);//对比测试

void SD8573_Series(void);//单独测试
void SD8573_and_std(void);//对比测试
...
void null(void);
/////////////////////////////////////
void f32768_8573(void);
void f13684_8573(void);
void f8192_8573(void);
void f4096_8573(void);
void f2048_8573(void);
void f1024_8573(void);
void f1_8573(void);
